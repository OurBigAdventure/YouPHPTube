...
// Check to ensure that the access token was successfully acquired.
    if ($client->getAccessToken()) {
        try {
            ...
            $obj->id = $status['id'];
            $obj->status = $status;
            $obj->msg = sprintf(__("Your video <a href='https://youtu.be/%s' target='_blank' class='btn btn-light'><span class='fab fa-youtube'></span> %s</a> was uploaded to your <a href='https://www.youtube.com/my_videos' class='btn btn-light' target='_blank'><span class='fab fa-youtube-square'></span> YouTube Account</a><br> "), $obj->id, $obj->title);
