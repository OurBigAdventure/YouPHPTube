...
<span class="badge badge-danger" id="liveViewStatus">OFFLINE</span>
<!--
<span class="badge badge-default" id="liveViewViews"><i class="fa fa-eye"></i> <span class="liveViewCount" style="font-size: 0.9em;">0</span></span>
-->
<script>
    function getStats() {
        $.ajax({
