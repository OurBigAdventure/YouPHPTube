...
<li>
    <div class="btn-group">
        <button type="button" class="btn btn-light  dropdown-toggle nav-item float-left"  data-toggle="dropdown">
            <span class="fas fa-cogs"></span> <span class="hidden-md hidden-sm"><?php echo __("Style & Themes") ?></span> <span class="caret"></span>
        </button>
        <ul class="dropdown-menu dropdown-menu-right" role="menu">
            ...
            <li  class="dropdown-submenu active" style=" min-width: 165px;">
                <img style='height: 60px; width: 60px; float: left;' alt='' class='img img-fluid  img-thumbnail ' src="<?php echo $global['webSiteRootURL']; ?>plugin/ThemeSwitcherMenu/icons/<?php echo $obj->page; ?>.png"/>
                <img style='height: 60px; width: 100px;' alt='' class='img img-fluid  img-thumbnail' src="<?php echo $global['webSiteRootURL']; ?>view/css/custom/<?php echo $obj->theme; ?>.png"/>
            </li>
            <li class="divider"></li>
