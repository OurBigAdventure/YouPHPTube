...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-sm btn-kv btn-light btn-outline-secondary',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-light btn-outline-secondary',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="glyphicon glyphicon-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="glyphicon glyphicon-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-light btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fas fa-search-plus"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-light btn-outline-secondary',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            ...
            toggleheader: 'btn btn-sm btn-kv btn-light btn-outline-secondary',
            fullscreen: 'btn btn-sm btn-kv btn-light btn-outline-secondary',
            borderless: 'btn btn-sm btn-kv btn-light btn-outline-secondary',
            close: 'btn btn-sm btn-kv btn-light btn-outline-secondary'
        },
        ...
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
        removeClass: 'btn btn-light btn-secondary',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-light btn-secondary',
        uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
        uploadClass: 'btn btn-light btn-secondary',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadExtraData: {},
