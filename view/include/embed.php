    ...
    <div class="col-sm-8 col-md-8 secC">
        <div id="videoContainer">
            <div id="floatButtons" style="display: none;">
                ...
                <button type="button" class="btn-outline btn-sm" onclick="closeFloatVideo();floatClosed = 1;">
            ...
            if ($video['rotation'] === "90" || $video['rotation'] === "270") {
                ...
                if (YouPHPTubePlugin::isEnabled("0e225f8e-15e2-43d4-8ff7-0cb07c2a2b3b")) {
                    ...
                    <div style="<?php echo $style; ?>">
                        <a href="<?php echo $url; ?>">
                            <img src="<?php echo $global['webSiteRootURL']; ?>videos/logoOverlay.png"  class="img-responsive col-lg-12 col-md-8 col-sm-7 col-6">
                        </a>
                    </div>
                    <?php
                }
