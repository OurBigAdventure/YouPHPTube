...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-kv btn-light btn-outline-secondary',
                    removeErrorClass: 'btn btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
                    uploadClass: 'btn btn-kv btn-light btn-outline-secondary',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="glyphicon glyphicon-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="glyphicon glyphicon-download"></i>',
                    downloadClass: 'btn btn-kv btn-light btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fas fa-search-plus"></i>',
                    zoomClass: 'btn btn-kv btn-light btn-outline-secondary',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            ...
            toggleheader: 'btn btn-kv btn-light btn-outline-secondary',
            fullscreen: 'btn btn-kv btn-light btn-outline-secondary',
            borderless: 'btn btn-kv btn-light btn-outline-secondary',
            close: 'btn btn-kv btn-light btn-outline-secondary'
        },
