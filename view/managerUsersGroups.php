...
<html lang="<?php echo $_SESSION['language']; ?>">
    ...
    <body>
        ...
        <div class="container">
            <div class="btn-group" >
                <button type="button" class="btn btn-light" id="addUserGroupsBtn">
                ...
                <a href="#" class="btn btn-info float-right" data-toggle="popover" title="<?php echo __("What is User Groups"); ?>" data-placement="bottom"  data-content="<?php echo __("This is where you can create groups and associate them with your videos and users.
                ...
                var grid = $("#grid").bootgrid({
                    ...
                    formatters: {
                        "commands": function (column, row)
                        {
                            ...
                            var deleteBtn = '<button type="button" class="btn ml-1 btn-light btn-sm command-delete"  data-row-id="' + row.id + '  data-toggle="tooltip" data-placement="left" title="Delete""><span class="fas fa-trash" aria-hidden="true"></span></button>';
