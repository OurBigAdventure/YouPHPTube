    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="btn-group float-right" role="group">
                <a href="<?php echo $global['webSiteRootURL']; ?>objects/videos.txt.php?type=seo" target="_blank" class="btn btn-light btn-sm">
                    <i class="fas fa-download"></i> <?php echo __("Download your videos list"); ?> (SEO .txt file)
                </a>
                <a href="<?php echo $global['webSiteRootURL']; ?>objects/videos.txt.php" target="_blank" class="btn btn-light btn-sm">
            ...
            if ((User::isAdmin()) && (!$config->getDisable_youtubeupload())) {
                ...
                <div class="alert alert-info">
                    ...
                    <ol>
                        <li>
                            <a href="<?php echo $global['webSiteRootURL']; ?>siteConfigurations" class="btn btn-info btn-sm">Enable Google Login</a> and get your google ID and Key
                        </li>
                        <li>
                            Go to https://console.developers.google.com
                            on <a href="https://console.developers.google.com/apis/dashboard" class="btn btn-info btn-sm" target="_blank">dashboard</a> Enable <strong>YouTube Data API v3</strong>
                        </li>
                        <li>
                            In credentials authorized this redirect URIs <code><?php echo $global['webSiteRootURL']; ?>objects/youtubeUpload.json.php</code>
                        </li>
                        <li>
                            You can find more help on <a href="https://developers.google.com/youtube/v3/getting-started" class="btn btn-info btn-sm"  target="_blank">https://developers.google.com/youtube/v3/getting-started </a>
                        </li>
                    </ol>
...
<?php } ?>
                                        ...
                                        var grid = $("#grid").bootgrid({
                                            ...
                                            formatters: {
                                                ...
                                                {
                                                    var editBtn = '<button type="button" class="mb-1 btn btn-sm btn-light command-edit" data-row-id="' + row.id + '" data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Edit")); ?>"><span class="fas fa-edit" aria-hidden="true"></span></button>'
                                                    var deleteBtn = '<button type="button" class="ml-1 mb-1 btn btn-light btn-sm command-delete"  data-row-id="' + row.id + '"  data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Delete")); ?>"><span class="fas fa-trash" aria-hidden="true"></span></button>';
                                                    var activeBtn = '<button style="color: #090" type="button" class="ml-1 mb-1 btn btn-light btn-sm command-active"  data-row-id="' + row.id + '"  data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Inactivate")); ?>"><span class="fas fa-eye" aria-hidden="true"></span></button>';
                                                    var inactiveBtn = '<button style="color: #A00" type="button" class=" ml-1 mb-1 btn btn-light  btn-sm command-inactive"  data-row-id="' + row.id + '"  data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Activate")); ?>"><span class="fas fa-eye-slash" aria-hidden="true"></span></button>';
                                                    var unlistedBtn = '<button style="color: #BBB" type="button" class="ml-1 mb-1 btn btn-light  btn-sm command-unlisted"  data-row-id="' + row.id + '"  data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Unlisted")); ?>"><span class="fas fa-eye" aria-hidden="true"></span></button>';
                                                    var rotateLeft = '<button type="button" class="btn btn-light btn-sm command-rotate"  data-row-id="left"  data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Rotate LEFT")); ?>"><span class="fa fa-undo" aria-hidden="true"></span></button>';
                                                    var rotateRight = '<button type="button" class="btn ml-1 btn-light  btn-sm command-rotate"  data-row-id="right"  data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Rotate RIGHT")); ?>"><span class="fas fa-redo " aria-hidden="true"></span></button>';
                                                    var rotateBtn = "<br>" + rotateLeft + rotateRight;
                                                    var suggestBtn = "";
<?php
if (User::isAdmin()) {
    ?>
                                                        var suggest = '<button style="color: #C60" type="button" class="ml-1 mb-1 btn btn-light  btn-sm command-suggest"  data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Suggest")); ?>"><i class="fas fa-star" aria-hidden="true"></i></button>';
                                                        var unsuggest = '<button style="" type="button" class="ml-1 mb-1  btn btn-light  btn-sm command-suggest unsuggest"  data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Unsuggest")); ?>"><i class="far fa-star" aria-hidden="true"></i></button>';
...
?>
                                                    ...
                                                    for (var k in row.videosURL) {
                                                        download += '<a href="' + row.videosURL[k].url + '?download=1" class="btn btn-sm btn-light" ><span class="fa fa-download " aria-hidden="true"></span> ' + k + '</a><br>';
                                                    }
...
<?php if (!$config->getDisable_youtubeupload()) { ?>
                                                        youTubeUpload = '<button type="button" class="btn btn-danger btn-sm command-uploadYoutube"  data-toggle="tooltip" data-placement="left" title="<?php echo str_replace("'", "\\'", __("Upload to YouTube")); ?>"><span class="fa fa-upload " aria-hidden="true"></span></button>';
...
?>
                                                    ...
                                                    return img + '<a href="<?php echo $global['webSiteRootURL']; ?>video/' + row.clean_title + '" class="btn btn-light btn-sm">' + type + row.title + "</a>" + tags + "" + yt;
                                                }
