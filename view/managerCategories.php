            ...
            $(document).ready(function () {
                ...
                var grid = $("#grid").bootgrid({
                    ...
                    formatters: {
                        ...
                        {
                            var editBtn = '<button type="button" class="btn btn-sm btn-light command-edit" data-row-id="' + row.id + '" data-toggle="tooltip" data-placement="left" title="<?php echo __("Edit"); ?>"><span class="fas fa-edit" aria-hidden="true"></span></button>'
                            var deleteBtn = '<button type="button" class="ml-1 btn btn-light btn-sm command-delete"  data-row-id="' + row.id + '  data-toggle="tooltip" data-placement="left" title="<?php echo __("Delete"); ?>"><span class="fas fa-trash" aria-hidden="true"></span></button>';
