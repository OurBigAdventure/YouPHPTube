...
$t['This page works only with a MP4 File, if you have or need any other format, try to install your own <a href=\'https://github.com/DanielnetoDotCom/YouPHPTube-Encoder\' class=\'btn-warning btn-sm\'>encoder</a> or use the <a href=\'https://encoder.youphptube.com/\' class=\'btn-warning btn-sm\'>public</a> one'] = "Esta página funciona apenas com um arquivo MP4, se você tiver ou precisar de qualquer outro formato, tente instalar seu próprio <a href = 'https: //github.com/DanielnetoDotCom/YouPHPTube-Encoder' class = 'btn btn-warning btn -xs '> codificador </a> ou use <a href='https://encoder.youphptube.com/' class='btn-warning btn-sm'> public </a> one";
