...
$t['This page works only with a MP4 File, if you have or need any other format, try to install your own <a href=\'https://github.com/DanielnetoDotCom/YouPHPTube-Encoder\' class=\'btn btn-warning btn-sm\'>encoder</a> or use the <a href=\'https://encoder.youphptube.com/\' class=\'btn btn-warning btn-sm\'>public</a> one'] = "Bu sayfa sadece bir MP4 Dosyası ile çalışır, eğer başka bir formata sahipseniz veya başka bir formata ihtiyacınız varsa, kendi <a href='https://github.com/DanielnetoDotCom/YouPHPTube-Encoder' class='btn btn-warning btn-sm'>Kodlayıcınız</a> ya da <a href='https://encoder.youphptube.com/' class='btn btn-warning btn-sm'>Genel</a>'i kullanın.";
...
$t['Your video <a href=\'https://youtu.be/%s\' target=\'_blank\' class=\'btn btn-light\'><span class=\'fa fa-youtube-play\'></span> %s</a> was uploaded to your <a href=\'https://www.youtube.com/my_videos\' class=\'btn btn-light\' target=\'_blank\'><span class=\'fa fa-youtube\'></span> YouTube Account</a><br> '] = "Videonuz <a href='https://youtu.be/%s' target='_blank' class='btn btn-light'><span class='fa fa-youtube-play'></span> %s</a>, <a href='https://www.youtube.com/my_videos' class='btn btn-light' target='_blank'><span class='fa fa-youtube'></span> YouTube Hesabınıza</a> yüklendi<br> ";
